# address-quality-service-api

![Build](https://github.com/NHSDigital/address-quality-service-api/workflows/Build/badge.svg?branch=master)
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/address-quality-service-api/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/address-quality-service-api/blob/master/CODE_OF_CONDUCT.md).
